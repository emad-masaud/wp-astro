...
3. Set these environment variables:
   - `WORDPRESS_API_URL` → e.g. `https://myblog.com/wp-json`
...
_mea-astro-extract/                 ← كود مستخرج لمشروع mea-astro المستقبلي
docs/
  woo-astro-README-template.md
  mea-astro-README-template.md
```

---

## المشاريع المصاحبة | Related projects

- **woo-astro** — WooCommerce + Astro integration (قادم)
- **mea-astro** — MeaChat + Google Auth + Astro integration (قادم)
